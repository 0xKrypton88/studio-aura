...
The supplied preview is authoritative for the complete clickable **Mina sidor / kundportal demo contract**. It is not permission to replace Studio Aura's identity, verified public content, or factual safety requirements. Use the original capture for business/content truth and the preview for portal interaction and visual-language guidance.
...
A darker Club Aurora or Mina sidor moment may be used as a **bounded accent section**, but the public site must not become globally dark. The separate **Bokningsprogram** prototype is a different Studio Aura surface — preserve it, but do not conflate it with Mina sidor.
